...
class _Portfolio:
    ...
    def db_report_portfolio_summary(self, account_id):
        ...
        return SimpleNamespace(
            ...
            activity_date_to=date(2026, 8, 21),
            cost_summary=(
                SimpleNamespace(
                    category="Securities commissions", net_cost_usd="10",
                    included_in_instrument_pnl=True,
                ),
                SimpleNamespace(
                    category="Broker Interest Paid", net_cost_usd="3",
                    included_in_instrument_pnl=False,
                ),
            ),
            total_costs_usd="13",
            costs_outside_instrument_pnl_usd="3",
            gross_dividend_payments_usd="20",
            dividend_withholding_tax_usd="4",
            net_dividend_payments_usd="16",
            securities_commission_summary=(
                SimpleNamespace(
                    instrument_type="Stocks", side="BUY", execution_count=2,
                    instrument_count=2, commission_usd="7",
                ),
                SimpleNamespace(
                    instrument_type="Options", side="SELL", execution_count=1,
                    instrument_count=1, commission_usd="5",
                ),
            ),
            securities_commission_date_from=date(2026, 8, 1),
            securities_commission_date_to=date(2026, 8, 20),
            securities_commission_execution_count=3,
            securities_commission_instrument_count=3,
            securities_commission_total_usd="12",
...
def test_portfolio_summary_exposes_cash_transfers_and_profit_contract() -> None:
    ...
    assert response.json() == {
        ...
        "activity_date_from": "2026-07-31",
        "activity_date_to": "2026-08-21",
        "cost_summary": [
            {
                "category": "Securities commissions",
                "net_cost_usd": "10",
                "included_in_instrument_pnl": True,
            },
            {
                "category": "Broker Interest Paid",
                "net_cost_usd": "3",
                "included_in_instrument_pnl": False,
            },
        ],
        ...
        "securities_commission_date_from": "2026-08-01",
        "securities_commission_date_to": "2026-08-20",
        "securities_commission_execution_count": 3,
        "securities_commission_instrument_count": 3,
        "securities_commission_total_usd": "12",
        "net_transfers_usd": "274",
