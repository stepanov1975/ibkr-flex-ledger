...
function renderHistory(report){
  ...
  el('history-state').textContent=report.provisional?'Provisional report: some history or valuation data is incomplete or requires review. N/A means a reliable value is unavailable.':'';
