...
def create_api_application(
    ...
    corporate_action_resolution_service: SQLAlchemyCorporateActionResolutionService | None = None,
) -> FastAPI:
    ...
    if portfolio_repository is not None:
        ...
        application.include_router(api_create_corporate_action_router(portfolio_repository, split_correction_service, corporate_action_resolution_service))
